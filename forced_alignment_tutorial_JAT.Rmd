---
title: "Forced Alignment with Wav2Vec2 - Originally written by Moto Hira"
author:
...
![https://download.pytorch.org/torchaudio/tutorial-assets/ctc-forward.png](ctc-forward.png)
...
```{r, echo=FALSE}
knitr::include_graphics("pyplot2.png")
```
...
## Generate the audio for full sample
